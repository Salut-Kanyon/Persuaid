              ...
              {!knowledgeOpen ? (
                ...
                >
                  <div className="pointer-events-none absolute inset-0 z-0" aria-hidden>
                    <img
                      src="/photo-1710678832243-cbfb55a0b806.avif"
                      alt=""
                  ...
                  <div className="relative z-10 flex min-h-0 flex-1 flex-col">
                    <div className="shrink-0 px-4 py-3 sm:px-6">
                      <button
                        ...
                        className={cn(
                          "group relative flex w-full items-center justify-between gap-3 rounded-2xl px-4 py-3.5 text-left",
                          "border border-white/70 bg-white/[0.04] backdrop-blur-2xl backdrop-saturate-150",
                      ...
                      >
                        <div className="min-w-0">
                          <div className="text-[17px] font-semibold tracking-tight text-text-primary sm:text-lg">
                            Add your product knowledge
                          </div>
                          <div className="mt-1 text-[13px] leading-snug text-text-muted sm:text-sm">
                            Notes, pricing, policies, and more used live on your calls
                          </div>
                        </div>
                        <svg
                          className="h-4 w-4 shrink-0 text-text-dim/70 transition-transform duration-300 ease-[cubic-bezier(0.22,1,0.36,1)] group-hover:translate-y-[2px]"
                          viewBox="0 0 24 24"
                          fill="none"
                          stroke="currentColor"
                          strokeWidth={2}
                ...
                >
                  <div className="flex shrink-0 items-start justify-between gap-3 px-4 py-2.5 sm:px-6 sm:py-3">
                    <div className="flex min-w-0 flex-col gap-0.5">
                      <h2 className="text-base font-medium tracking-tight text-text-primary sm:text-[17px]">
                        Add your product knowledge
                      </h2>
                      <p className="text-[13px] leading-snug text-text-muted sm:text-sm">
                        Notes, pricing, policies, and more used live on your calls
                      </p>
                    </div>
                    <button
                      ...
                      className={cn(
                        ...
                        "border border-white/[0.12] bg-white/[0.03] text-text-primary/90",
                        "backdrop-blur-xl backdrop-saturate-150",
                        "transition-[transform,background-color] duration-200 ease-out hover:bg-white/[0.06] active:scale-[0.97]"
                      )}
                      aria-label="Close product knowledge"
                    >
                      Close

        ...
        {suggestions.map((suggestion, index) => (
          ...
          >
            {index === 0 && suggestion.priority === "high" && (
              <div className="absolute top-0 left-0 w-0.5 h-full bg-gradient-to-b from-green-primary/50 to-green-accent/35 rounded-l-2xl"></div>
            )}
            <div className="flex items-start gap-3.5">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2.5 mb-2.5">
                  ...
                  <div className={`px-2 py-0.5 rounded-lg text-[10px] font-medium border ${getPriorityColor(suggestion.priority)}`}>
                    {suggestion.priority}
                  </div>
                </div>
